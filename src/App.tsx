      ...
      <div className="h-screen grid grid-col-1 md:grid-cols-2">
         ...
         >
            ...
            <div className="w-full pl-5 pr-28 py-5 space-y-6 bg-white h-full bg-opacity-70 backdrop-blur-sm">
               <div>
                  <h1 className="text-start text-gray-900 font-bold text-4xl uppercase font-serif">Space Quiz</h1>
         ...
         <div className="flex w-full justify-center items-center bg-black space-y-8 ">
            <div className="w-full px-8 md:px-32 lg:px-24 max-w-7xl mx-auto ">
               {state.game === "idle" ? (
                  <h1 className="text-white text-center">Let's take the quiz!</h1>
                              ...
                              <ul className="flex flex-col items-center gap-10">
                                 {state.questions[state.current].choices.map(({ id, choice }, index) => (
                                    <button
                                       ...
                                       key={id}
                                       className={`${
                                          state.choice === index ? "bg-indigo-500 hover:bg-indigo-400" : "bg-stone-300 hover:bg-stone-200"
