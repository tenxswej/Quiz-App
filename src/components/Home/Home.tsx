            ...
            <div className="flex w-full justify-center items-center bg-black space-y-8 ">
                <div className="w-full px-8 md:px-32 lg:px-24 max-w-7xl mx-auto ">
                    {state.game === "idle" ? (
                        ...
                        <div className="max-w-[330px] mx-auto py-3 text-center bg-[#BAB0B0] rounded-[20px] text-[#1A1A1C] flex flex-col items-center justify-center font-bold">Get Started</div>
